...
async def _plan_watchers(
    ...
    остаются. Наблюдателям членство раздавать НЕЛЬЗЯ: viewer в проекте видит
    его целиком, и подписка на одну задачу открыла бы человеку весь целевой
    проект. Поэтому неучастников отписываем.
