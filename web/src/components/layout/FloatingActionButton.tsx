...
import { useProjectFolders } from '@/hooks/useProjects'
  ...
  return (
    <>
      ...
      >
        ...
        {/* Личное достижимо инпутом на вкладке «Личные», но FAB — то место,
            куда на телефоне смотрят, когда хотят что-то создать. */}
        {personalProjectId && (
          <BottomSheetItem
            ...
            onClick={() => {
              ...
              window.setTimeout(() => {
                // Инпут живёт на вкладке «Личные» и на других вкладках не
                // смонтирован — ловить событие некому; ведём на /my, где
                // `?new=personal` откроет нужную вкладку и сфокусирует строку.
