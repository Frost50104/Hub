 ...
 * то, что от него нужно, и благодарим после отправки; ключ созданной задачи
 * ему бесполезен — проекта он не видит.
 */
export function FeedbackDialog({
  ...
  const submit = async () => {
    ...
    try {
      ...
      toast.success('Спасибо! Сообщение отправлено — мы его прочитаем')
      onOpenChange(false)
    } catch {
