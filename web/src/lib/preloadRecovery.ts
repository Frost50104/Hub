 ...
 *
 * С 16.09 это перезагрузка последнего рубежа (с 25.09 рядом только киоск
 * `RaceTvPage`; слушатель плагина PWA, перезагружавший соседние вкладки,
 * снят вместе с плагином): из баннера обновления таймер убран (ОС «работа не сохраняется, даже если не
