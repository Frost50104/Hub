        ...
        >
          ...
          <DialogFooter className="flex-wrap">
            ...
            {/* ОС 19.08: «опубликованный опрос не правится и не удаляется» —
                кнопка просто исчезала, и это читалось как поломка. Ограничение
                намеренное (ответы уже собраны), поэтому объясняем его вслух. */}
            {published && (
              <p className="w-full text-[13px] leading-[1.45] text-text2">
                Удалить опубликованный опрос нельзя — ответы уже собраны, и
                статистика перестала бы сходиться. Отправьте его в архив: он
                исчезнет у сотрудников, а результаты сохранятся.
              </p>
            )}
