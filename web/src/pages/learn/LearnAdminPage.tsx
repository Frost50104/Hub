...
const SUBTITLE: Record<AdminSegment, string> = {
  ...
  progress:
    'Кто и сколько обязательных курсов прошёл — по людям, точкам и должностям. Считает только курсы: аттестации и ознакомления живут в своих отчётах.',
      ...
      <div className="mt-5">
        ...
        {me.data && allowed.length === 0 && (
          <EmptyState
            ...
            text="Разделы управления открываются публикаторам, руководителям точек и администраторам. Если вы ждёте доступ — напишите администратору Hub."
          />
        )}
        {Tab && (
